...
<head>
    ...
    <style type="text/css">
        ...
        .cr-message{background-color:rgba(9,104,109,.9);border-color:rgba(38,178,171,.9);font-family:"Roboto Mono",monospace;font-size:18px;color:#3ffdff;box-shadow:0 1px 3px transparent}.cr-context-message{background-color:rgba(9,104,109,.9);border-color:rgba(38,178,171,.9);font-family:"Roboto Mono",monospace;color:#3ffdff;box-shadow:0 1px 3px transparent}.cr-context-message a:hover{color:#c5feff}
        </style>
</head>
<body class="cr-body">
